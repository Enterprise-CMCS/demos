...
5.  From your branch, make a pull request against `Enterprise-CMCS/demos/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `Enterprise-CMCS/demos/main`
...
DEMOS will see regular updates and new releases. This section describes the general guidelines around how and when a new release is cut.
...
DEMOS uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/Enterprise-CMCS/DEMOS/tags) of the form `X.Y.Z`.
...
The following steps outline the process to prepare a Release Candidate of DEMOS. This process makes public the intention and contents of an upcoming release, while allowing work on the next release to continue as usual in `dev`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of DEMOS:
...
[proj-releases-new]: https://github.com/Enterprise-CMCS/DEMOS/releases/new
...
docs. Please file an [issue](https://github.com/Enterprise-CMCS/DEMOS/issues).
-->
