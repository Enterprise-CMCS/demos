/*
  ...
  - Added the required column `with_role_id` to the `event` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "with_role_id" UUID NOT NULL;
