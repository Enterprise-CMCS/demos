-- AlterTable
ALTER TABLE "amendment" ADD COLUMN     "signature_level_id" TEXT;

-- AlterTable
ALTER TABLE "amendment_history" ADD COLUMN     "signature_level_id" TEXT;

-- AlterTable
ALTER TABLE "extension" ADD COLUMN     "signature_level_id" TEXT;

-- AlterTable
ALTER TABLE "extension_history" ADD COLUMN     "signature_level_id" TEXT;
