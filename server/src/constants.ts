...
export const ADMIN_USER_PERMISSIONS: Permission[] = [
  "Resolve Demonstration",
  "Resolve Demonstration Application Workflow",
  "Resolve Demonstration Documents",
  "Resolve Demonstration Contacts",
...
export const CMS_USER_PERMISSIONS: Permission[] = [
  "Resolve Demonstration",
  "Resolve Demonstration Application Workflow",
  "Resolve Demonstration Documents",
  "Resolve Demonstration Contacts",
...
export const READ_ONLY_CMS_USER_PERMISSIONS: Permission[] = [
  "Resolve Demonstration",
  "Resolve Demonstration Application Workflow",
  "Resolve Demonstration Documents",
  "Resolve Demonstration Contacts",
...
export const STATE_USER_PERMISSIONS: Permission[] = [
  "Resolve Demonstration",
  "Resolve Person",
  "Resolve State",
  "Resolve User",
