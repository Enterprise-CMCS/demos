...
import {
  DemonstrationDetailsTab,
  DemonstrationDetailsTabDemonstration,
} from "./DemonstrationDetailsTab";
      ...
      {demonstration && (
        <>
          ...
          <div className="mt-4 h-[60vh] overflow-y-auto">
            {tab === "details" && <DemonstrationDetailsTab demonstration={demonstration} />}
            {tab === "amendments" && (
              <AmendmentsTab
