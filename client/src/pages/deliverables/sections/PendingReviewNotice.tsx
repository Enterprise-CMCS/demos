...
export const PendingReviewNotice: React.FC<{ onStartReview: () => void }> = ({ onStartReview }) => {
  return (
    <div
    ...
    >
      ...
      <div className="flex-1 leading-2">
        ...
        <p className="text-sm text-text-font">State User has submitted deliverable(s) for review</p>
      </div>
