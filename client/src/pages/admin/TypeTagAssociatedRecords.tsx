...
interface TypeTagAssociatedRecordsProps {
  selectedTypeTag: string;
  onClear: () => void;
}

export const TypeTagAssociatedRecords: React.FC<TypeTagAssociatedRecordsProps> = ({
  selectedTypeTag,
  onClear,
}) => {
  return (
    <div className="flex flex-col gap-1" data-testid={TYPE_TAG_ASSOCIATED_RECORDS_TEST_ID}>
      ...
      <TypeTagAssociatedRecordsTable selectedTypeTag={selectedTypeTag} />
    </div>
  );
};
