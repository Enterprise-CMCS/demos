...
export const mockDemonstrations = [
  {
    ...
    demonstrationStatus: mockDemonstrationStatuses.find((s) => s.name === "Approved")!,
  ...
  },
  {
    ...
    demonstrationStatus: mockDemonstrationStatuses.find((s) => s.name === "Pre-Submission")!,
  ...
  },
  {
    ...
    demonstrationStatus: mockDemonstrationStatuses.find((s) => s.name === "On-hold")!,
