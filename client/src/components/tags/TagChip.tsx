...
const STYLES = {
  ...
  suggestionChip: tw`border border-purple-200 bg-purple-50 px-2 py-1 font-semibold text-purple-700 hover:border-purple-400 hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-300 disabled:cursor-not-allowed disabled:opacity-60`,
