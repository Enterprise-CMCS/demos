...
export type DeliverableTableRow = Omit<
  Deliverable,
  "demonstration" | "cmsOwner" | "demonstrationTypes" | "cmsDocuments" | "stateDocuments" | "name" | "dueDateType" | "expectedToBeSubmitted" | "createdAt" | "updatedAt" | "cmsDocuments" | "stateDocuments"
> & {
  name: string;
