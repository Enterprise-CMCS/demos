...
import { SelectDemonstrationTypeTag } from "./SelectDemonstrationTypeTag";
...
describe("SelectDemonstrationTypeTag", () => {
  ...
  it("renders SelectTag with correct label", () => {
    render(<SelectDemonstrationTypeTag value="" onSelect={mockOnSelect} />);
  ...
  it("passes value prop to SelectTag", () => {
    render(<SelectDemonstrationTypeTag value="Type A" onSelect={mockOnSelect} />);
  ...
  it("passes isRequired prop to SelectTag when provided", () => {
    render(<SelectDemonstrationTypeTag value="" onSelect={mockOnSelect} isRequired />);
  ...
  it("passes filter prop to SelectTag when provided", () => {
    ...
    render(<SelectDemonstrationTypeTag value="" onSelect={mockOnSelect} filter={filterFn} />);
