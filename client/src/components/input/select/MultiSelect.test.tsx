...
describe("Multiselect", () => {
  ...
  it("renders input with placeholder", () => {
    render(<Multiselect options={options} onChange={onSelect} placeholder="Pick fruit" />);
    expect(screen.getByPlaceholderText("Pick fruit")).toBeInTheDocument();
  });

  it("renders label and required indicator", () => {
    render(
      <Multiselect options={options} onChange={onSelect} label="Fruit" isRequired id="fruit" />
    );
  ...
  it("renders disabled input", () => {
    render(<Multiselect options={options} onChange={onSelect} isDisabled placeholder="Disabled" />);
    expect(screen.getByPlaceholderText("Disabled")).toBeDisabled();
  });

  it("opens dropdown on input focus", async () => {
    render(<Multiselect options={options} onChange={onSelect} />);
  ...
  it("closes dropdown on outside click", async () => {
    render(
      <div>
        <Multiselect options={options} onChange={onSelect} />
