...
interface HorizontalSectionTabsProps extends Omit<TabsProps, "styles"> {
  ...
  const borderedStyles: TabsStyles = {
    getButtonStyles: (isSelected: boolean) =>
      `p-1 font-medium cursor-pointer bg-white ${
        isSelected
          ? "border-t-4 border-t-focus border-r-1 border-r-gray-dark border-l-1 border-l-gray-dark font-semibold"
