...
export function applyFileUploadSuppressions(fileUpload: Stack, stage: string) {
  ...
  NagSuppressions.addResourceSuppressionsByPath(
    fileUpload,
    `/demos-${stage}-file-upload/BudgetNeutralityProcessor/budgetNeutralityValidation/budgetNeutralityValidationLambdaExecutionRole/Resource`,
    [
      {
        id: "AwsSolutions-IAM5",
        reason: "Permissions given are required for the lambda execution role. Some wildcards are unavoidable (VPC networking).",
  ...
  NagSuppressions.addResourceSuppressionsByPath(
    fileUpload,
    `/demos-${stage}-file-upload/BudgetNeutralityProcessor/budgetNeutralityValidation/budgetNeutralityValidationLambdaExecutionRole/DefaultPolicy/Resource`,
    [
      {
        id: "AwsSolutions-IAM5",
