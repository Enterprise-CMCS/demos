...
echo ""
echo "7️⃣ Setting up BN notebook validation Lambda..."
bash /workspaces/demos/.devcontainer/localstack/setup/setup_bnnotebookvalidation_lambda.sh
...
echo "   - Lambda Functions: fileprocess, uipath, deleteinfectedfile, bnnotebookvalidation"
