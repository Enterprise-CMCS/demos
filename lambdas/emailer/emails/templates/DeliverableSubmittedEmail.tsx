...
export function renderDeliverableSubmittedEmail(rawPayload: unknown): EmailTemplateResult {
      ...
      <DeliverableEmailLayout
        ...
        message={
          <Text style={textStyle}>
            A {deliverableType} deliverable has been submitted for your Demonstration.{" "}
