...
export function renderExtensionDecisionMadeEmail(rawPayload: unknown): EmailTemplateResult {
  ...
  if (extensionDecision !== "Approved" && extensionDecision !== "Denied") {
    throw new Error(
      ...
      <DeliverableEmailLayout
        ...
        message={
          <Text style={textStyle}>
            CMS has {extensionDecision} an extension request for your {deliverableType} deliverable.
            The current due date is {currentDueDate}. <DeliverableLink href={link} />
          </Text>
        }
