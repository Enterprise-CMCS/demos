 ...
 * Refs:       reports/pgm_dtl_tag_mapping_pending.csv, sql/21_app_associative/12_pending_demonstration_type_tag_assignment.sql, sql/04_crosswalks/46_pgm_dtl_tag.sql
 *
 * Crosswalk: PMDA mdcd_pendg_*_pgm_dtl source table -> DEMOS tag_name, the
 * pending-track counterpart of mysql_raw.crosswalk_pgm_dtl_tag (04/46). Loaded
 ...
 * skipped by the loader, mirroring 04/46.
 *
