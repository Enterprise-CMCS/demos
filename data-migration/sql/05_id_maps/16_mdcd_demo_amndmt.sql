/*
 * Purpose: Create the (empty) migration._id_map_mdcd_demo_amndmt table mapping legacy mdcd_demo_amndmt.mdcd_demo_amndmt_id to a minted DEMOS uuid; populated later in 10_stg. Idempotent.
 * Refs:    docs/developer/reference-id-maps.adoc
 *
 * Id map: legacy mysql_raw.mdcd_demo_amndmt.mdcd_demo_amndmt_id (int) -> DEMOS uuid.
 ...
 */
CREATE TABLE IF NOT EXISTS migration._id_map_mdcd_demo_amndmt(
