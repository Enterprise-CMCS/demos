// Generated from reports/narrative/history_strategy.md by docs/tools/md_to_adoc.py -- do not edit.
...
forbid _reading_ the PMDA source `*_hstry` tables to derive real target values.
