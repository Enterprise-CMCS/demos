CREATE TABLE legacy_pmda_raw.mdcd_pendg_emer_wvr_authrty_pgm_dtl_hstry (
    mdcd_pendg_emer_wvr_authrty_pgm_dtl_hstry_id INTEGER,
    mdcd_pendg_emer_wvr_authrty_pgm_dtl_id INTEGER,
